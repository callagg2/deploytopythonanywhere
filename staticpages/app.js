...
function getAllAjax(){
    $.ajax({
        "url": "https://callagg2.pythonanywhere.com/books",
        "method":"GET",
        "data":"",
        "dataType": "JSON",
...
function updateBookAjax(book){
    ...
    console.log(JSON.stringify(book));
    $.ajax({
        "url": "https://callagg2.pythonanywhere.com/books/"+encodeURI(book.id),
        "method":"PUT",
        "data":JSON.stringify(book),
        "dataType": "JSON",
        contentType: "application/json ; charset=utf-8",
...
function deleteBookAjax(id){
    ...
    $.ajax({
        "url": "https://callagg2.pythonanywhere.com/books/"+encodeURI(id),
        "method":"DELETE",
        "data":"",
        "dataType": "JSON",
        contentType: "application/json; charset=utf-8",
